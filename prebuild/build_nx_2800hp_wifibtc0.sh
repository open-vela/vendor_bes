...
function build()
{
    ...
    elif [ "$1" = "ap_wifibtc0" ]; then
        cmd=$cmd"DSP_HIFI4_TRC_TO_MCU=1 UTILS_ESHELL_BTRF_TEST=1 WIFI_ANA_YB_CFG=1 CHIP_HAS_CP=0 CP_AS_SUBSYS=0\
            WIFI_RF_SW_IO_SELECT=1 ESHELL_ECHOBACK=0 USE_NTS_HEAP=0 MM_PROJECT=$MM_PROJECT"
